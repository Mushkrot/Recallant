...
The shipped observability contract remains supported because it protects capture truth and makes
continuity failures diagnosable. Additional replay, telemetry, or orchestration depth is not a
current product milestone unless the active Cross-Client Continuity or Human Document Memory work
shows a concrete diagnostic or safety requirement.
