...
Roadmap boundary: this shipped contract remains supported and tested, but further graph expansion is
deprioritized unless Cross-Client Continuity or Human Document Memory demonstrates a concrete
retrieval or governance requirement. See the [Roadmap](ROADMAP.md).
