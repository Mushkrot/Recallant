...
3. Continue Phase 8 hardening from the current checkpoint: backup/export portability remapping gaps and remaining safe hardening that does not require owner secrets or production service changes.
