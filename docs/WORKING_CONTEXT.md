...
3. Continue with remaining cleanup/lifecycle polish and then run a broader smoke suite. Do not perform production service changes, paid API calls, or destructive erasure without owner participation.
