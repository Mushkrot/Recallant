...
3. Continue Phase 8 hardening from the current checkpoint: backup/export portability gaps, richer restore verification checks, and remaining safe hardening that does not require owner secrets or production service changes.
