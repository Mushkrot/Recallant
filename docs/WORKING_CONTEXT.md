...
- 2026-06-02 Source-aware governed recall follow-up: `memory_recall_agent_memories` accepts
  `source_id`; Management Chat passes the active Workbench source filter into same-project memory
  lookup; and Ask Recallant discloses the current memory-space source filter in lookup answers.
...
- 2026-06-02 full core QA checkpoint after focused Workbench visual QA, Management Chat policy
  ...
  report again proved clean attach/capture/recall/detach, copied sandbox original untouched,
  production-sensitive guided preflight, and source-linked cross-project recall with examples that
  remain non-binding.
