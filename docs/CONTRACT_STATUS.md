...
- `remote-doctor --capture-proof` currently proves session/context readiness, while strict semantic
  memory proof requires a governed memory write plus recall;
