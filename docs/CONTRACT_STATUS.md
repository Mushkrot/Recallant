...
- Remote MCP/agent access now has a first authenticated `POST /api/mcp` endpoint slice, scoped
  ...
  `8fa139a4-13f2-419e-8ae7-1611e16c86fa`; local stdio MCP remains the default client workflow until
  broader remote-client polish and repeat release rehearsals are complete.
