...
const fakeApiKey = `${['s', 'k-', 'syntheticfixture'].join('')}-${randomUUID().replaceAll("-", "")}`;
...
const fakeDatabaseUrl = ['postgresql://', 'example-user:example-password@127.0.0.1:5432/example-db'].join('');
