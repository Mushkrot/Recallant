...
mustInclude(
  ...
  [
    ...
    "persists readiness evidence",
    "later `recallant agent-start` reads that evidence",
    "Checkpoint-only readback and capture-proof do not imply",
    "last semantic proof",
    "System activity ledger",
    "redacted system activity audit reports",
    "smoke-backed lifecycle closeout gate",
    "`agent-lifecycle-gate:smoke`",
    "`agent-capture:smoke`",
...
mustInclude(
  ...
  [
    ...
    "From OpenHuman,",
    "From Kortix/Suna,",
    "work should travel as a task record",
...
mustInclude(
  ...
  [
    ...
    "Open Engine task handoff analysis",
    "portable task records",
    "one-loop audits",
    "Recallant-owned task handoff",
