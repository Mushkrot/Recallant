...
mustInclude(
  ...
  [
    ...
    "raw.githubusercontent.com/Mushkrot/Recallant/v0.1.0-dev.3/scripts/install-recallant-bootstrap.sh",
    "--ref v0.1.0-dev.3",
...
assert(packageJson.version === "0.1.0-dev.3", "Root package must carry prerelease identity");
assert(
