...
const namedProjectId = "00000000-0000-4000-8000-000000000003";
const secondNamedProjectId = "00000000-0000-4000-8000-000000000009";
...
const baseDashboard = {
  ...
  projects: [
    { project_id: currentProjectId, name: "recallant", primary_path: "/srv/example-project" },
    {
...
try {
  ...
  assert(
    virtualSpace.understanding.source === "local_ai" &&
      ...
      virtualSpace.source_action_result?.project_id === "00000000-0000-4000-8000-000000000002",
  ...
  const sourceAttach = await buildManagementChatResponse({
    message: "Attach /srv/example-project as a source to the current memory space",
    dashboard: baseDashboard,
    database: {
      attachProjectSource: async (input) => {
  ...
  const concreteOnboarding = await buildManagementChatResponse({
    message: "Connect /srv/example-project with Cursor and mandatory startup hooks",
    dashboard: baseDashboard
  });
  assert(
