...
assertRedacted(aligned.raw, ["example-password"]);
...
assertRedacted(mismatch.raw, [mismatchPassword, "postgres://example-user:example-password@127.0.0.1:5432/example-db"]);
...
const adminEmail = "maintainer@example.com";
...
assertRedacted(publicReadiness.raw, [adminEmail, "example-password"]);
